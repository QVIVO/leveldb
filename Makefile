...
.cc.o:
	...
	mkdir -p ios-arm/$(dir $@)
	$(CXX) $(CXXFLAGS) -isysroot $(DEVICEROOT)/SDKs/iPhoneOS$(IOSVERSION).sdk -arch armv6 -arch armv7 -arch armv7s -c $< -o ios-arm/$@
...
.c.o:
	...
	mkdir -p ios-arm/$(dir $@)
	$(CC) $(CFLAGS) -isysroot $(DEVICEROOT)/SDKs/iPhoneOS$(IOSVERSION).sdk -arch armv6 -arch armv7 -arch armv7s -c $< -o ios-arm/$@
	lipo ios-x86/$@ ios-arm/$@ -create -output $@
